...
def opt_hps(func, X, Y, epochs, batchsizes, layers, show_progress=False):
    ...
    best_model, best_acc = func(X, Y, epochs[0], batchsizes[0], layers[0])
...
dnn_grid_f1, dnn_model = opt_hps(DNN, red_feat_x, red_feat_y, dnn_epochs, dnn_batchsizes, dnn_layers, show_progress=True)
